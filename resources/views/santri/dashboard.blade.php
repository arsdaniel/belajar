                            ...
                            <div class="card author-box card-primary">
                                <div class="card-body">
                                    ...
                                    <div class="author-box-name">
                                        <a href="#" class="text-primary mb-2">{{ Auth::user()->name }}
                                            {{ Auth::user()->nama_belakang }} </a>
                                    </div>
                                    ...
                                    <div class="author-box-description">
                                        ...
                                        Status Pendaftaran : <a class="text-warning mb-2">
                                            <h6>Berkas kamu sedang di Evaluasi Admin</h6>
                                        </a><br>
